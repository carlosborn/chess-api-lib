...
public class ClubMembersRequest extends AbstractRequest {

    public ClubMembersRequest(String urlId) {
        this.addPathParameter("club", urlId);
        this.addPathParameter("members", "");
    ...
    public Response getResponse(String response, int httpCode, Map<String, String> headers, String errorMessage) {
        return ClubMembersResponse.newBuilder()
                .setBody(response)
